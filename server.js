...
const ENABLE_SUPABASE = Boolean((process.env.ENABLE_SUPABASE !== 'false') && SUPABASE_URL && SUPABASE_KEY);

let dbCache = null;
let dbCacheTime = 0;
const CACHE_TTL_MS = 5000; // 5s smart in-memory cache for ultra-fast 0.01s load speeds & low egress
